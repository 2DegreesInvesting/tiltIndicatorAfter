...
At last, this function calculates the input sector decarbonisation indicator's 
product and company level results.
...
function (from [tiltIndicatorAfter](https://github.com/2DegreesInvesting/tiltIndicatorAfter)). 
At last, this function calculates the input relative emission indicator's product and company 
level results.
