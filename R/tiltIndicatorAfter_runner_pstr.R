...
# #PSTR
#
# pstr_comp <- read_csv("/Users/kalashsinghal/git/2DII/tiltIndicatorAfter/vignettes/articles/test/pstr_companies.csv", col_types = cols(isic_4digit = col_character()), col_select = -company_name) |>
...
# # pstr_product_result |>
# #   write_csv("/Users/kalashsinghal/git/2DII/tiltIndicatorAfter/vignettes/articles/test/pstr_product_result.csv")
#
# pstr_company_result <- map_df(pstr_job$file_company, read_rds)
# pstr_company_result
# # TODO: `... |> write_csv("/path/to/output/pstr_company_result.csv")`
# # pstr_company_result |>
# #   write_csv("/Users/kalashsinghal/git/2DII/tiltIndicatorAfter/vignettes/articles/test/pstr_company_result.csv")
#
#
