...
#' @importFrom tiltIndicator summarize_range
...
#' @importFrom tiltTransitionRisk add_transition_risk_category
#' @importFrom tiltTransitionRisk toy_all_uuids_scenario_sectors
