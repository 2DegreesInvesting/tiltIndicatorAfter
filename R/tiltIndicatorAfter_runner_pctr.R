...
#
# # PCTR
# pctr_comp <- read_csv("/Users/kalashsinghal/git/2DII/tiltIndicatorAfter/vignettes/articles/test/xctr_companies.csv") |>
...
#   )))
#
# pctr_prod <- read_csv("/Users/kalashsinghal/git/2DII/tiltIndicatorAfter/vignettes/articles/test/pctr_products.csv", col_types = cols(isic_4digit = col_character()), show_col_types = FALSE) |>
#   select(all_of(c(
#     "co2_footprint",
#     "tilt_sector",
#     "unit",
